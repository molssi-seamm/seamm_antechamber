# -*- coding: utf-8 -*-
"""
Control parameters for the Antechamber step in a SEAMM flowchart
"""
...
class AntechamberParameters(seamm.Parameters):
    """
    ...
    See Also
    --------
    Antechamber, TkAntechamber, Antechamber
    AntechamberParameters, AntechamberStep
    ...
    def __init__(self, defaults={}, data=None):
        ...
        logger.debug('AntechamberParameters.__init__')

        super().__init__(
            defaults={**AntechamberParameters.parameters, **defaults},
            data=data
        )
