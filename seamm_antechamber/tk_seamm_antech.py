...
"""The graphical part of a Antechamber step"""
...
class TkAntechamber(seamm.TkNode):
    """
    The graphical part of a Antechamber step in a flowchart.
    ...
    self[widget] : dict
        ...
        contained in Antechamber_parameters.py

    See Also
    --------
    Antechamber, TkAntechamber,
    AntechamberParameters,
    """
    ...
    def create_dialog(self):
        ...
        based on what is specified in the Antechamber_parameters
        module.
        ...
        See Also
        --------
        TkAntechamber.reset_dialog
        """

        frame = super().create_dialog(title='Antechamber')
    ...
    def edit(self):
        """Present a dialog for editing the Antechamber input
    ...
    def handle_help(self):
        ...
        None
        """
        print('Help not implemented yet for Antechamber!')
